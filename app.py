...
# Center point for Northern Virginia
LAT = 38.85
LNG = -77.30
...
def load_intelligence_data():
    """
    Reads the parquet file generated by your GitHub Action.
    """
    USER = "Hazemadam"
    ...
    try:
        ...
        # If the file hasn't been pushed yet or URL is wrong
        st.error(f"Cloud data not found yet. Check if 'nova_data.parquet' exists in your repo.")
        dummy_data = pd.DataFrame({
            ...
            "type": ["status"],
            "city": ["NOVA"],
            "street": ["Waiting for Scraper"],
            "source": ["Fallback"],
        })
        return dummy_data, "Offline/Error Mode"
...
# Apply the risk model to our loaded data
...
with col2:
    ...
    if not filtered_df.empty:
        ...
        st.write("No high-risk points detected with current filters.")
